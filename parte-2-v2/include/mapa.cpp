...
void mapa::print_coso()
{
    ...
    {
        cout << "Colegio " << colegios[i].get_cole() << " en " << colegios[i].get_parada() << endl;
    }

    cout << "\n------------- NIÑOS -------------" << endl;
    for(size_t i = 0; i < children.size(); i++)
    {
        cout << "Niño " << i << " en " << children[i].get_parada() << " hacia "
        << children[i].get_colegio() << endl;
    }
